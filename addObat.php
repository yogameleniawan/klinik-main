        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Obat</h1><br>
                    <!-- DataTales Example -->
                    <div class="col-lg-10 col-md-10">
                        <div class="media d-block mb-4 text-left probootstrap-media">
                            <div class="col-lg-6">
                                <form class="user" method="POST" action="prosesAddObat.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <p>ID :</p>
                                        <input type="text" class="form-control form-control-user" name="idobat">
                                    </div>
                                    <div class="form-group">
                                        <p>Nama Obat :</p>
                                    ...
                                    <div class="form-group">
                                        <p>Gambar:</p>
                                        <input type="file" class="form-control form-control-user" name="image_obat">
                                    </div>
