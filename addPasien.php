        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Data Pasien</h1><br>
                    <!-- DataTales Example -->
                    <div class="col-lg-10 col-md-10">
                        <div class="media d-block mb-4 text-left probootstrap-media">
                            <div class="col-lg-6">
                                <form class="user" method="POST" action="prosesAddPasien.php">
                                    ...
                                    <div class="form-group">
                                        <p>Jenis Kelamin :</p>
                                        <input type="text" class="form-control form-control-user" name="kelamin">
                                    </div>
                                    <div class="form-group">
                                        <p>Alamat :</p>
                                    ...
                                    <div class="form-group">
                                        <p>Suhu Badan :</p>
                                        <input type="text" class="form-control form-control-user" name="suhu">
                                    </div>
                                    <div class="form-group">
                                        <p>Password :</p>
